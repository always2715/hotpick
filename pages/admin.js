...
const CURRENT_CONTENT_VERSION=140;
...
export default function Admin(props){
  ...
  return <><Head><title>관리자 — STELLATE v8.0.56</title></Head><Header/><main className="admin-shell">
    <section className="admin-heading"><div><p className="eyebrow">STELLATE v8.0.56</p><h1>검증형 운영 관리자</h1></div><button className="admin-logout" onClick={logout}>로그아웃</button></section>
