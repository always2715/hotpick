...
export default function handler(req,res){
  ...
  return res.status(200).json({
    ...
    engine:'fixed-keyword-top20-single-candidate-qstash-v8033',
    feedFallback:'published-content-source-of-truth-and-index-rebuild-v8030-plus-canonical-run-snapshot-alias-v8033',
    ...
    topKeywordPolicy:'v8020-relative-ranking-fixed-20-with-invalid-fragment-exclusion-v8033',
    keywordExtractionPolicy:'single-representative-entity-and-headline-fragment-rejection-v8033',
    ...
    publicTopCount:20,
    stageDurability:'publication-stage-plus-run-snapshot-candidate-and-slug-alias-self-healing-v8033',
