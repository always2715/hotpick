...
export function publicContentRejectionReasons(content={}) {
  ...
  const enforceFlexibleFeedLength=Number(content?.contentVersion||0)>=134||['v8044-2000-3000','v8045-min1000-target5000'].includes(String(content?.feedDetailLengthPolicy||''));
