...
assert.match(api,/export const CONTENT_VERSION = 132/);
assert.match(api,/const TREND_CACHE_VERSION = 51/);
...
console.log('STELLATE v8.0.36 TOP25 generation pool, successful TOP20 publication, and precision tests: PASS');
