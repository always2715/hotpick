...
assert.match(apiSource,/const TREND_CACHE_VERSION = 51/);
assert.match(apiSource,/export const CONTENT_VERSION = 132/);
...
assert.match(adminSource,/CURRENT_CONTENT_VERSION=132/);
