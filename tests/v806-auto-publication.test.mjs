...
assert.match(apiSource,/const TREND_CACHE_VERSION = 48/);
assert.match(apiSource,/export const CONTENT_VERSION = 128/);
...
assert.match(adminSource,/CURRENT_CONTENT_VERSION=128/);
