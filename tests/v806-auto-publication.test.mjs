...
assert.match(apiSource,/const TREND_CACHE_VERSION = 47/);
assert.match(apiSource,/export const CONTENT_VERSION = 127/);
...
assert.match(adminSource,/CURRENT_CONTENT_VERSION=127/);
