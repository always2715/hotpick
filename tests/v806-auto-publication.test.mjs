...
assert.match(apiSource,/const TREND_CACHE_VERSION = 56/);
assert.match(apiSource,/export const CONTENT_VERSION = 139/);
...
assert.match(adminSource,/CURRENT_CONTENT_VERSION=139/);
