...
assert.match(apiSource,/const TREND_CACHE_VERSION = 46/);
assert.match(apiSource,/export const CONTENT_VERSION = 126/);
assert.match(apiSource,/isAutomaticPublicationReady\(candidate\)\|\|fixedTopReady/);
...
assert.match(adminSource,/CURRENT_CONTENT_VERSION=126/);
