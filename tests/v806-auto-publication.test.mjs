...
assert.match(apiSource,/const TREND_CACHE_VERSION = 49/);
assert.match(apiSource,/export const CONTENT_VERSION = 129/);
...
assert.match(adminSource,/CURRENT_CONTENT_VERSION=129/);
