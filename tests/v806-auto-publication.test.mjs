...
assert.match(apiSource,/const TREND_CACHE_VERSION = 57/);
assert.match(apiSource,/export const CONTENT_VERSION = 140/);
...
assert.match(adminSource,/CURRENT_CONTENT_VERSION=140/);
