...
assert.match(apiSource,/const TREND_CACHE_VERSION = 54/);
assert.match(apiSource,/export const CONTENT_VERSION = 137/);
...
assert.match(adminSource,/CURRENT_CONTENT_VERSION=135/);
