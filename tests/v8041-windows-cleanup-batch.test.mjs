...
const batPath = path.join(projectRoot, 'APPLY_STELLATE_v8.0.45_CLEANUP.bat');
...
assert.equal(pkg.version, '8.0.45');
assert.match(pkg.scripts['test:v8041'], /v8041-windows-cleanup-batch/);

console.log('STELLATE v8.0.45 Windows cleanup BAT encoding tests: PASS');
