...
assert.ok(/^8\.0\.(?:26|27|28|29|30|31|32|33|34)$/.test(pkg.version));
assert.match(version,/contentVersion:130/,'정확성 엔진 변경으로 기존 저품질 캐시를 폐기해야 합니다.');
...
assert.match(admin,/STELLATE v8\.0\.34/);
