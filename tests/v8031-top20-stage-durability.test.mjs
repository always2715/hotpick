...
const genericOnly={
  contentVersion:129,status:'published',visibility:'published',contentMode:'detailed',contentType:'detailed',hasContent:true,
...
assert.match(versionSource,/contentVersion:129/);
assert.match(versionSource,/trendCacheVersion:49/);
