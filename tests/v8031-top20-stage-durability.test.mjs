...
const genericOnly={
  contentVersion:127,status:'published',visibility:'published',contentMode:'detailed',contentType:'detailed',hasContent:true,
...
assert.match(refreshSource,/stageRecoveredFrom:'legacy_slug_stage'/,'slug stage를 실행별 stage로 승격해야 합니다.');
...
assert.match(versionSource,/contentVersion:127/);
assert.match(versionSource,/trendCacheVersion:47/);
