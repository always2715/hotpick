...
const genericOnly={
  contentVersion:128,status:'published',visibility:'published',contentMode:'detailed',contentType:'detailed',hasContent:true,
...
assert.match(versionSource,/contentVersion:128/);
assert.match(versionSource,/trendCacheVersion:48/);
